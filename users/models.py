...
class UserManager(BaseUserManager):
    def create_user(self, user_id, full_name, password=None, **extra_fields):
        ...
        role = extra_fields.pop("role", None)  # safely pop role out of extra_fields
        if not role:
    ...
    def create_superuser(self, user_id, full_name="Admin", password=None, **extra_fields):
        ...
        extra_fields.setdefault("role", "admin")  # force role=admin for superusers
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    REQUIRED_FIELDS = ["full_name", "role"]  # Django will prompt for these in createsuperuser
